...
* Entrez vos identifiants de connexion à la base de données dans le fichier Model.php situé dans le dossier model (ligne 12)
...
* Enter your connexion settings in the file Model.php located in the model folder (line 12)
